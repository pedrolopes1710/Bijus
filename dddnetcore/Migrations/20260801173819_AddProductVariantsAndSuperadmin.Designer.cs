...
namespace DDDNetCore.Migrations
{
    ...
    [Migration("20260801173819_AddProductVariantsAndSuperadmin")]
    partial class AddProductVariantsAndSuperadmin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("dddnetcore.Domain.Produtos.Produto", b =>
                {
                    ...
                    b.Property<string>("ConfiguracaoVariantes")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("{\"opcoes\":[],\"variantes\":[]}");
